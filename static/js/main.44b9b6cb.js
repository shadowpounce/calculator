/*! For license information please see main.44b9b6cb.js.LICENSE.txt */
!(function () {
  'use strict'
  var e = {
      463: function (e, n, t) {
        ...
        function Oo(e, n) {
          ...
          if (
            ...
            if (
              ((t.flags |= 2048),
              Vo(9, Ro.bind(null, t, r, l, n), void 0, null),
              null === zi)
            )
              throw Error(a(349))
            0 !== (30 & mo) || Fo(t, n, l)
          ...
          uu = {
            ...
            useSyncExternalStore: function (e, n, t) {
              ...
              return (
                ...
                (r.flags |= 2048),
                Vo(9, Ro.bind(null, r, o, t, n), void 0, null),
                t
              )
            },
            useId: function () {
              ...
              if (((t = n.type), null !== e && null != n.stateNode))
                ...
                if (((e = to(Ja.current)), fa(n))) {
                  ...
                  switch (
                    ...
                    case 'video':
                    case 'audio':
                      for (l = 0; l < Mr.length; l++) Vr(Mr[l], r)
                      break
                    case 'source':
                      Vr('error', r)
                      break
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Ra(l, n, o)) && (ts(e, l, o, a), Ma(e, l, o)),
            o
          )
        }
        function Ws(e) {
  ...
  !(function () {
    ...
    var a = 'Buttons_buttons__sFTiq',
      o = 'Buttons_button__DwEl3',
      u = 'Buttons_buttonAction__Z9YEd',
      i = 'Buttons_buttonClear__oNeDi',
      s = t(184),
      c = function (e) {
        var n = e.children,
          t = e.btnType,
          ...
          i = e.setFirstValue,
          c = e.calculation,
          f = e.setIsFractionalValue,
          d = e.isFractionalValue,
          p = e.className
          ...
          onClick: function () {
            switch (t) {
              ...
              case 'number':
                ...
                break
              case 'remove':
                1 === r.length ? l('0') : l(r.slice(0, -1))
                break
              case 'action':
                switch (n) {
                  case '=':
                    l(String(c(a, u, r))), i(''), o('')
                    break
                  case 'AC':
                    l('0'), i(''), o('')
                    break
    ...
    function h(n) {
      return (
        n &&
        n.map(function (n, t) {
          return e.createElement(n.tag, p({ key: t }, n.attr), h(n.child))
        })
      )
    }
    function v(n) {
      return function (t) {
        return e.createElement(g, p({ attr: p({}, n.attr) }, t), h(n.child))
      }
    }
    function g(n) {
      var t = function (t) {
    ...
    var b = [
        { className: i, id: 0, btnType: 'action', body: 'AC' },
        {
          className: 'remove-btn ' + i,
          id: 1,
          btnType: 'remove',
          body: (0, s.jsx)(y, {}),
        },
        { className: u, id: 2, btnType: 'sign', body: '%' },
        { className: u, id: 3, btnType: 'sign', body: '/' },
        { className: o, id: 4, btnType: 'number', body: '1' },
        { className: o, id: 5, btnType: 'number', body: '2' },
        { className: o, id: 6, btnType: 'number', body: '3' },
        { className: u, id: 7, btnType: 'sign', body: 'X' },
        { className: o, id: 8, btnType: 'number', body: '4' },
        { className: o, id: 9, btnType: 'number', body: '5' },
        { className: o, id: 10, btnType: 'number', body: '6' },
        { className: u, id: 11, btnType: 'sign', body: '-' },
        { className: o, id: 12, btnType: 'number', body: '7' },
        { className: o, id: 13, btnType: 'number', body: '8' },
        { className: o, id: 14, btnType: 'number', body: '9' },
        { className: u, id: 15, btnType: 'sign', body: '+' },
        { className: o, id: 17, btnType: 'number', body: '0' },
        { className: o, id: 18, btnType: 'action', body: '.' },
        { className: u, id: 19, btnType: 'action', body: '=' },
      ],
      k = function (e) {
        var n = e.setValue,
          t = e.value,
        ...
        return (0, s.jsx)('div', {
          ...
          children: b.map(function (e) {
            return (0,
            s.jsx)(c, { setIsFractionalValue: f, isFractionalValue: d, calculation: i, firstValue: o, setFirstValue: u, sign: r, setSign: l, value: t, setValue: n, btnType: e.btnType, className: e.className, children: e.body }, e.id)
          }),
        })
      },
      w = 'Output_output__gYWBN',
      S = 'Output_signLabel__IFAZk',
      x = function (e) {
        var n = e.sign,
          t = e.value,
          r = e.firstValue
        return (0, s.jsxs)('div', {
          ...
          children: [
            (0, s.jsx)('label', {
              htmlFor: '',
              className: S,
              children: '' !== t || '' !== r ? ''.concat(n) : void 0,
            }),
            (0, s.jsx)('p', { children: r }),
            (0, s.jsx)('input', { value: t, type: 'text', readOnly: !0 }),
          ],
        })
      }
    var E = function () {
      ...
      return (
        ...
        (0, s.jsxs)('div', {
          className: 'App',
          children: [
            (0, s.jsx)(x, { sign: t, firstValue: c, value: o }),
            (0, s.jsx)(k, {
              setIsFractionalValue: m,
              isFractionalValue: p,
              calculation: function (e, n, t) {
                switch (e) {
                  case '+':
    ...
    n.createRoot(document.getElementById('root')).render((0, s.jsx)(E, {}))
  })()
})()
//# sourceMappingURL=main.44b9b6cb.js.map
